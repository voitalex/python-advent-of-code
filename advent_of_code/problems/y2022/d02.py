...
def _parse_round(string: str) -> Round:
    """ Возвращает ход игроков в структурированном виде """
    my, opponent = string.split(' ')
    return Round(my=MyChoice(my), opponent=OpponentChoice(opponent))
...
def first_task(strings: Iterable[str]) -> int:
    ...
    def score(round: Round) -> int:
        """ Возвращает количество ходов за ход """
